...
public class Audio extends VLCInterface
{
	public static enum AudioChannel
	{
		...
		/**
		 * Method for obtaining the value of this enum.
		 * 
		 * @return The integer value associated with this enum.
		 */
		public int valueOf()
		{
	 ...
	 */
	public native int getTrack() throws VLCException;
	 ...
	 * @throws	VLCException	If an error occurs.
	 */
	public native void setTrack(int track) throws VLCException;
    ...
    /**
     * Mutator for muting of audio output.
     * 
     * @param	value	True if audio output should be muted; false otherwise.
     * @throws	VLCException	If an error occurs.
     */
    public native void setMuted(boolean value) throws VLCException;
    
    /**
     * Toggles audio output between muted and unmuted.
     * 
     * @throws	VLCException	If an error occurs.
     */
